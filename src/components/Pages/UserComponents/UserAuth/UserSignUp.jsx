...
import { Grid, Paper, Avatar, Typography, TextField, Button , IconButton} from '@mui/material';
...
const UserSignUp = () => {
  ...
  const handleSignUp = async (event) => {
    ...
    const requiredFields = ['firstName', 'lastName', 'email', 'password', 'phoneNumber', 'pincode', 'state', 'city'];
